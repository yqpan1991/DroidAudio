 ...
 * 学习使用系统Media相关的使用
 */
public class OpusByManagerActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String LOG_TAG = "["+OpusByManagerActivity.class.getSimpleName()+"]";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pcm_by_manager);
    ...
    private synchronized void handleRecord() {
        MediaManager.getInstance().startRecord(RecordType.OPUS);
    }
