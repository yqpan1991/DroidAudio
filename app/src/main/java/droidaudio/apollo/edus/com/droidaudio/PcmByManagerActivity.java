 ...
 * 学习使用系统Media相关的使用
 */
public class PcmByManagerActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String LOG_TAG = "["+PcmByManagerActivity.class.getSimpleName()+"]";
    ...
    private synchronized void handleRecord() {
        MediaManager.getInstance().startRecord(RecordType.PCM);
    }
